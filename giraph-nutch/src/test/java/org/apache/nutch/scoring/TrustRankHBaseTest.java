...
public class TrustRankHBaseTest extends BspCase {
  ...
  private final Logger LOG = Logger.getLogger(org.apache.nutch.scoring.TrustRankHBaseTest.class);
  ...
  public TrustRankHBaseTest() {
    super(org.apache.nutch.scoring.HostRankHBaseTest.class.getName());
