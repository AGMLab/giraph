...
public class HostRankHBaseTest extends BspCase {
  ...
  public void testHBaseInputOutput() throws Exception {
    ...
    try {
      ...
      final byte[] QUALIFIER_PAGERANK = Bytes.toBytes("hostrank");
      ...
      giraphConf.setVertexInputFormatClass(NutchHostRankInputFormat.class);
      giraphConf.setVertexOutputFormatClass(NutchHostRankOutputFormat.class);
