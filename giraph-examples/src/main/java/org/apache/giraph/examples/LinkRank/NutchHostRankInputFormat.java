 ...
 */
public class NutchHostRankInputFormat extends
  ...
  private static final Logger LOG =
      Logger.getLogger(NutchHostRankInputFormat.class);
  ...
  public static class NutchTableEdgeVertexReader
    ...
    public String getHost(String uri) throws MalformedURLException {
        LOG.info("================= was: " + uri);
        URL url = new URL(uri);
