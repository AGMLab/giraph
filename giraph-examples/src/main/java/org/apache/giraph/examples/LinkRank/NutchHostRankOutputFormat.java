 ...
 */
public class NutchHostRankOutputFormat
  ...
  private static final Logger LOG =
          Logger.getLogger(NutchHostRankOutputFormat.class);
  ...
  public static class NutchTableEdgeVertexWriter
    ...
    /**
     * Score qualifier "hostrank". Calculated scores will be written here.
     */
    private static final byte[] HOSTRANK_QUALIFIER = Bytes.toBytes("hostrank");
    ...
    public void writeVertex(
      ...
      if (valueStr.length() > 0) {
        put.add(SCORE_FAMILY, HOSTRANK_QUALIFIER, valueBytes);
